               ...
               <div className='col-lg-4'>
                  <div className='support-container'>
                     ...
                     <p className='m-2 text-center'>
                        We have 50+ people in trade and support department who
                        are always available to answer your queries, requests
                        24x7, round the clock. Have queries?
                     </p>
                  </div>
               </div>
               <div className='col-lg-4'>
                  <div className='support-container'>
                     ...
                     <p className='m-2 text-center'>
                        Our super qualified technocrats and experienced R&D team
                        make sure that every tile that reaches you is of great
                        quality. We do not compromise on this aspect.
                     </p>
                  </div>
               </div>
               <div className='col-lg-4'>
